    ...
    <Layout>
      <div className="about-us-page">
        <div className="pcontainer">
          <div className="">
            <h1 className="about-us-heading mb-4 mt-3">About Inizia</h1>
            Welcome to Inizia - Your Ultimate Event Experience!
            ...
            <ul>
              <li><strong>Innovative Simplicity:</strong> Inizia simplifies the complex world of event planning with intuitive tools that make creating events a breeze.</li>
              <li><strong>Endless Possibilities:</strong> We provide you with the canvas to customize every detail, ensuring that your event is a true reflection of your vision.</li>
              <li><strong>Seamless Experience:</strong> From booking to feedback, Inizia ensures a seamless journey for both organizers and attendees.</li>
              <li><strong>Real-Time Insights:</strong> Get valuable insights into your event's performance and engagement, allowing you to refine and enhance future experiences.</li>
            </ul>

            {/* Rest of the content... */}
            
            <h2 class="my-3">Join Us in Redefining Moments</h2>
            We invite you to be a part of the Inizia community and experience the evolution of event planning. Together, let's redefine how moments are created, celebrated, and cherished.

            Join us today and Inizia your journey of extraordinary events!
          </div>
        </div>
      </div>
    </Layout>
